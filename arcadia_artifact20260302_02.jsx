...
export default function Arcadia() {
  ...
  if (phase === "battle") {
    ...
    const battleBg = battleBgUrl
      ? `url(${battleBgUrl}) center/cover no-repeat, linear-gradient(180deg,${ed.bg[0]} 0%,${ed.bg[1]} 50%,${ed.bg[2]} 100%)`
    ...
    return (
      <div style={{width:"100%",height:"100%",minHeight:"600px",display:"flex",flexDirection:"column",background:battleBg,fontFamily:"'Noto Serif JP',serif",userSelect:"none",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px 20px 10px"}}>
          ...
          {enemyImgUrl
            ? <img src={enemyImgUrl} alt={ed.name} style={{width:isBoss?220:140,height:isBoss?220:140,objectFit:"contain",animation:isBoss?"bossFloat 2s infinite":"idle 2s infinite",filter:isBoss?`drop-shadow(0 0 20px ${C.red})`:"drop-shadow(0 4px 12px rgba(0,0,0,0.8))",transform:btlAnimEnemy?"scale(1.1)":"scale(1)",transition:"transform 0.1s",imageRendering:"auto"}} />
